    ...
    >
      <div className='w-full max-w-5xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        <motion.div
          ...
          className='bg-gradient-to-br from-green-100 to-green-200 p-10'
        >
          ...
          <div className='space-y-4'>
            {[
              ...
              <motion.div
                ...
                className='flex items-center gap-4 bg-white px-4 py-4 rounded-xl shadow-sm'
              >
                {item.icon}
        ...
        <motion.div
          ...
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 0.7 }}
          className='p-10 bg-white flex flex-col'
        >
          ...
          <div className='space-y-5'>
            <div className='relative'>
              <FaUserTie className='absolute top-1/2 left-4 -translate-y-1/2 text-gray-400' />
              <input
                type='text'
                placeholder='Enter role'
                value={role}
                onChange={(e) => setRole(e.target.value)}
                className='w-full h-12 pl-12 pr-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none'
              />
            </div>
            ...
            <select
              ...
              className='w-full h-12 px-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none'
            >
