...
function Home() {
  ...
  return (
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col overflow-visible'>
      <Navbar />

      <div className='flex-1 px-6 py-20 overflow-visible'>
        ...
        {/* STEP CARDS */}
        <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-20 pt-6'>
          {[
            {
            ...
            <motion.div
              ...
              className={`
                ...
                pt-12 pb-10 px-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl
                ${index === 0 ? "rotate-[-4deg]" : ""}
                ${index === 1 ? "rotate-[3deg] md:-mt-6 shadow-xl" : ""}
                ${index === 2 ? "rotate-[-3deg]" : ""}
              `}
            >
              <div className='absolute -top-6 left-1/2 -translate-x-1/2 bg-white border-2 border-green-500 text-green-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg'>
                {moveItem.icon}
              </div>
          ...
          <div className='grid md:grid-cols-2 gap-10'>
            {[
              ...
              <motion.div
                ...
                className='bg-white border rounded-3xl p-8 shadow-sm hover:shadow-xl'
              >
  ...
  <div className='grid md:grid-cols-2 gap-10'>
    {[
      ...
      },
      {
        ...
        desc: "Deep Technical questioning based on a selected role."
      },
      {
        image: confidenceImg,
        icon: <BsMic size={20} />,
